...
[{ name = "node1", mac = "52:54:00:a1:9c:ae", domain = "node1.example.com", install_dev = "nvme0n1"}]
EOD
}
...
[
  { name = "node2", mac = "52:54:00:b2:2f:86", domain = "node2.example.com", install_dev = "nvme0n1"},
  { name = "node3", mac = "52:54:00:c3:61:77", domain = "node3.example.com", install_dev = "nvme4n1"}
]
EOD
}
